What makes this radar project unique is that the radar unit is separate from the display.
The radar module communicates with the Arduino GIGA R1 via a Wi-Fi hotspot using an ESP32 S3.
This allows it to be used as a motion detector regardless of the display's position.
...
List of components:
1x Arduino Giga R1
1x Arduino Display Shield
1x Seed studio XIAO ESP32-S3
2x toggle switch
1x 3,7V Lipo 1160100
1x 3,7V Lipo 602560
1x RD03-D radarmodul from Ai-Thinker
2x MT3608 Step up converter
1x BW4056 usbc charging module
2x magnets

Wires, melt-in thread insert M3, M3x10mm screws, 3D printer, glue, tape ist needed.
